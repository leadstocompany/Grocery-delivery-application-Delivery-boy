        ...
        errorWidget: (context, url, error) {
          return Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isBorderShow ? Colors.red : Colors.transparent,
                  width: 1,
                )),
            child: Center(
                child: Image.asset(
        ...
        imageBuilder: (context, cIMage) {
          return Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(color: isBorderShow ?  Colors.red : Colors.transparent, width: 1),
                image: DecorationImage(
                  fit: boxFit ?? BoxFit.contain,
                  colorFilter: isShowColor ? ColorFilter.mode(imageColor ??  Colors.red, BlendMode.srcIn) : null,
                  image: cIMage,
                )),
          );
        },
